...
public class UnloadPluginWindow extends JDialog {
	private ActionJList pluginList;
	private File path = null;

	public UnloadPluginWindow(JFrame parent) {
		...
		pluginList = new ActionJList(PluginManager.getLoadedPlugins());
		...
		pluginList.addActionListener(
				new ActionListener() {
			        ...
			        public void actionPerformed(ActionEvent ae) {
						...
						UnloadPluginWindow.this.dispose();
			         }
			     });
